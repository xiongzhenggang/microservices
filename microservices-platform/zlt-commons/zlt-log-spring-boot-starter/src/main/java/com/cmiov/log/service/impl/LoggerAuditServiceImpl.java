package com.cmiov.log.service.impl;

import com.cmiov.log.model.Audit;
import com.cmiov.log.service.IAuditService;
...
public class LoggerAuditServiceImpl implements IAuditService {
     ...
     * 例子：2020-02-04 09:13:34.650|user-center|com.cmiov.user.controller.SysUserController|saveOrUpdate|1|admin|webApp|新增用户:admin
     */
    @Override
