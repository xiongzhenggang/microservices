package com.xzg.log.service.impl;

import com.xzg.log.model.Audit;
import com.xzg.log.service.IAuditService;
...
public class LoggerAuditServiceImpl implements IAuditService {
     ...
     * 例子：2020-02-04 09:13:34.650|user-center|com.xzg.user.controller.SysUserController|saveOrUpdate|1|admin|webApp|新增用户:admin
     */
    @Override
