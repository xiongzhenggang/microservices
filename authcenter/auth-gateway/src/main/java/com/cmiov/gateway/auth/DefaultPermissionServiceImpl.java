package com.cmiov.gateway.auth;

import com.cmiov.gateway.constant.CommonConstant;
import com.cmiov.gateway.model.SysMenu;
import com.cmiov.gateway.properties.SecurityProperties;
import com.cmiov.gateway.utils.AuthenticationUtil;
...
//            TenantContextHolder.setTenant(clientId);
            ...
            String roleCodes = grantedAuthorityList.stream().map(SimpleGrantedAuthority::getAuthority).collect(Collectors.joining( CommonConstant.COMMA_SPLIT ));
